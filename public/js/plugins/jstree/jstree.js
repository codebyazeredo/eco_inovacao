/*! jsTree - v3.3.11 - 2021-02-04 - (MIT) */ ! function (a) {
  "use strict";
  ...
  if (!a.jstree) {
    ...
    !j && k && (j = function (a, b) {
      ...
      _load_node: function (b, c) {
        ...
        }, this)) : "object" == typeof d ? d.url ? (d = a.extend(!0, {}, d), a.vakata.is_function(d.url) && (d.url = d.url.call(this, b)), a.vakata.is_function(d.data) && (d.data = d.data.call(this, b)), a.ajax(d).done(a.proxy(function (d, e, g) {
      ...
      _parse_model_from_json: function (a, c, d) {
        ...
        if (a && a.id && (l.id = a.id.toString()), a && a.text && (l.text = a.text), a && a.data && a.data.jstree && a.data.jstree.icon && (l.icon = a.data.jstree.icon),
          (l.icon === b || null === l.icon || "" === l.icon) && (l.icon = !0), a && a.data && (l.data = a.data, a.data.jstree))
        ...
        this.init = function (a, b) {
          ...
          if (!e) {
            ...
            if (this._data.massload = {}, h.length) {
              ...
              if ("object" == typeof g && g && g.url) return g = a.extend(!0, {}, g), a.vakata.is_function(g.url) && (g.url = g.url.call(this, h)), a.vakata.is_function(g.data) && (g.data = g.data.call(this, h)), a.ajax(g).done(a.proxy(function (a, g, h) {
                var i, j;
                if (a)
